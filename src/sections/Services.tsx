...
import { HandshakeIcon, Search, Settings, RefreshCw } from 'lucide-react';
...
const services = [
  {
    ...
    duration: '60–90 минут, бесплатно',
    description: 'Разбираемся, чем могу быть полезен именно вам',
    details: [
      'Прямой разговор о том, что происходит в компании сейчас',
      'Решаем вместе, есть ли смысл идти дальше'
    ]
  },
  {
    number: '02',
    ...
    title: 'Диагностика',
    duration: '2–4 недели',
    description: 'Понимаю, как на самом деле устроено управление в компании',
    details: [
      'Собираю информацию, анализирую процессы',
      'Опрашиваю ключевых руководителей (анкета и личные встречи)',
      'Готовлю письменный отчёт с честной картиной и предложениями'
    ]
  },
  {
    number: '03',
    ...
    duration: '4 месяца',
    description: 'То, чего не хватало бизнесу: работающая система управления',
    details: [
      'Ясная цель, к которой идёт вся команда',
      'Понятно, кто за что отвечает',
      'Цифры, которым доверяют, и встречи, где принимают решения'
    ]
  },
  {
    number: '04',
    ...
    description: 'Система работает без меня — я рядом, чтобы двигаться дальше.',
    details: [
      'Участие в ежемесячной встрече по итогам',
      'Разбор отчётности и план-факта вместе с вами',
      'Раз в год — стратегическая сессия: сверяем курс с целью бизнеса',
      'Донастройка системы под новые задачи'
    ]
  }
];
